...
const userAffiliations = [
  {
    id: 'c7662045-150e-4af8-b12c-8316727b4a49',
    account: 'vv@vv',
    fullName: 'aaa ddd',
    '096ad488-85ae-4fc0-80f2-678e7fc9d753': [
      'c9bb2a22-2a4b-4310-8703-6cf9ac009bc8',
    ],
  },
  { id: '40c3fffd-1ddf-4556-b37d-78b035f31273', account: '', fullName: ' ' },
  { id: '6ea30ec0-26a3-454e-94e0-c8c83c14cb48', account: '', fullName: ' ' },
  { id: '733addb8-e6d5-4c9d-84ca-3f32964c6249', account: '', fullName: ' ' },
  { id: 'd586026b-be4c-4bef-9dcb-f98c78a406df', account: '', fullName: ' ' },
  { id: 'c4d54428-21be-4e58-8010-40f3e052cafb', account: '', fullName: ' ' },
  { id: '5e03d25b-a119-4f61-b2c5-31c10f091fb0', account: '', fullName: ' ' },
  { id: '0c99199c-516a-40f8-85cc-c65b9034cdfb', account: '', fullName: ' ' },
  { id: '14d49482-c736-42fc-b5dd-5db698ba2699', account: '', fullName: ' ' },
  { id: '8dbc73e4-5617-4cf8-9e7d-ceba6a911cfa', account: '', fullName: ' ' },
  { id: '7f896afb-fe89-4c2f-bf0c-d83ec9d6930a', account: '', fullName: ' ' },
  { id: '5064c030-61dd-4d37-b831-98e0d899df47', account: '', fullName: ' ' },
  { id: '33fcfe1b-48a0-4061-9529-a73f25e89b77', account: '', fullName: ' ' },
  { id: '1b2f2cbb-dfbc-4b15-9f11-cf430ade21ee', account: '', fullName: ' ' },
  { id: '302b92c5-ddbf-422f-977f-75a9c0907f89', account: '', fullName: ' ' },
  { id: 'a8561d6d-4346-4647-8b05-738269679a98', account: '', fullName: ' ' },
  { id: '5d0a7893-ffbc-47b1-a1a3-b0bbb2468a19', account: '', fullName: ' ' },
  { id: '98caf0e9-294c-412b-bcf7-c2d103ef06a9', account: '', fullName: ' ' },
  { id: '02990c01-059c-4983-ac78-a1236f98f9f0', account: '', fullName: ' ' },
  { id: '0494246b-ba97-405f-a3c3-82d71cac2009', account: '', fullName: ' ' },
]
const departments = [
  {
    id: '7bdcb590-3b1f-42b5-89f7-2b55d30d67fd',
    name: 'aaa',
    code: 'aa',
    isEnabled: true,
    parentIds: [],
  ...
  {
    id: 'd02c3eb7-aa7b-45a8-b353-e09cebc26396',
    name: 'cccc',
    code: 'cccc',
    isEnabled: true,
    parentIds: ['7bdcb590-3b1f-42b5-89f7-2b55d30d67fd'],
  },
  {
    id: '',
    name: 'sss',
    ...
    isEnabled: true,
    parentIds: [
      '7bdcb590-3b1f-42b5-89f7-2b55d30d67fd',
      'd02c3eb7-aa7b-45a8-b353-e09cebc26396',
      '',
    ],
  },
]
const positions = [
  {
    id: 'f19f2341-5422-4c39-af0a-b2b790965c05',
    name: 'aaaa',
    code: 'aaaa',
    isEnabled: true,
    isQualityManager: false,
    competenceBrowseLevel: 111,
  },
  {
    id: '51d086aa-1cda-4a8d-9773-a778cb55b0d8',
    name: '1',
    code: '1',
    isEnabled: true,
    isQualityManager: false,
    competenceBrowseLevel: 243,
  },
  {
    id: 'bb38f03f-c237-439b-819e-2a518cb869f1',
    name: '2',
    code: '2',
    isEnabled: true,
    isQualityManager: false,
    competenceBrowseLevel: 444,
  },
  {
    id: '2e08387b-ce3c-44d2-84cd-e67ac42a074b',
    name: '3',
    code: '3',
    isEnabled: true,
    isQualityManager: false,
    competenceBrowseLevel: null,
  },
  {
    id: 'c9bb2a22-2a4b-4310-8703-6cf9ac009bc8',
    name: '45',
    code: '45',
    isEnabled: true,
    isQualityManager: false,
  ...
  {
    id: '567f5ae4-e451-4a31-b809-4dffee66e319',
    name: '6',
    code: '6',
    isEnabled: true,
    isQualityManager: false,
  ...
  {
    id: '00a59349-640c-4a14-95ef-d35c0a671be9',
    name: '87',
    code: '87',
    isEnabled: true,
    isQualityManager: false,
...
const MultiSelectComponent = React.memo<
  CellProps<any[], MultiSelectColumnData<any[]>>
>(
  ({
    active,
    focus,
...
export function createMultiSelectColumn<
  T extends any[] = { label: string; value: string }[]
>({
  placeholder,
  alignRight = false,
...
}: MultiSelectColumnOptions<T> = {}): Partial<
  Column<T, MultiSelectColumnData<T>, string>
> {
  return {
    component: MultiSelectComponent as unknown as CellComponent<
      T,
      MultiSelectColumnData<T>
    >,
    columnData: {
      placeholder,
      alignRight,
